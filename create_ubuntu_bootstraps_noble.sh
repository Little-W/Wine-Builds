...
apt-get -y install libxrender-dev libxext-dev libpcsclite-dev libcups2-dev libosmesa6-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev gstreamer1.0 gstreamer1.0-plugins*
...
if ! [ -d /usr/local/llvm-mingw ]; then
	wget -O llvm-mingw.tar.xz https://github.com/mstorsjo/llvm-mingw/releases/download/20240805/llvm-mingw-20240805-ucrt-ubuntu-20.04-x86_64.tar.xz
	tar -xf llvm-mingw.tar.xz -C /usr/local
	mv /usr/local/llvm-mingw-20240805-ucrt-ubuntu-20.04-x86_64 /usr/local/llvm-mingw
