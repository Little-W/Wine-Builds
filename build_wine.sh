...
export WINE_VERSION="6e15604c48acd63dd8095a4ce2fd011cb3be96db"
# This only applies to winello-git branches. Takes tag names or commit hashes (e.g. v9.11)
export STAGING_VERSION="5eeb4b76d6f460456238582d5e3fc200dcfae1f6"
...
if [ "$WINE_OSU" = "true" ]; then
	...
	_common_cflags="-march=x86-64 -mtune=generic -O3 -msse3 -mfpmath=sse -pipe -fno-strict-aliasing -fomit-frame-pointer -fwrapv -Wno-error=incompatible-pointer-types -Wno-error=implicit-function-declaration -Wno-error=int-conversion -w"
